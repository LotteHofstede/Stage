<?php			
	...
	while ($starttime < $endtime) {
		...
		$queryTime = new MongoDate($starttime + 500);
	...
	$jsonfile = fopen("/var/www/html/img_urls/" . $filename,'w');
